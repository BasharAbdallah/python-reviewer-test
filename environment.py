...
# building the environment in a class - in order to 

class Environment(object):
    
    # creating PARAMETERS AND VARIABLES of the environment, The default value is assigned when they are created.
    ...
    # this method updates the Environment after the RL model plays an action
    ...
    def update_env(self, direction, energy_ai, month):
        ...
        energy_noai = 0 # defult value - just to start, and then will be changed by random 
        ...
        self.reward = 1e-3 * self.reward # Scaling the Reward
        ...
        # GETTING GAME OVER - this is when the RL rewards are going to worst then the simulation must stop
    ...
    # A METHOD THAT GIVES US AT ANY TIME THE CURRENT STATE, THE LAST REWARD AND WHETHER THE GAME IS OVER
